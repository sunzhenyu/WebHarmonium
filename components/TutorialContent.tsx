  ...
  return (
    <>
      ...
      <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-3xl font-semibold mb-4 text-gray-900">{t.tutorialPage.section1Title}</h2>

        <h3 className="text-xl font-semibold mb-3 text-gray-800">{t.tutorialPage.keyboardLayoutTitle}</h3>
        ...
        <div className="bg-gray-50 p-4 rounded mb-4">
          ...
          <p className="text-sm text-gray-600 mt-2">{t.tutorialPage.whiteKeysDesc}</p>
        </div>
        ...
        <div className="bg-gray-50 p-4 rounded mb-4">
          ...
          <p className="text-sm text-gray-600 mt-2">{t.tutorialPage.blackKeysDesc}</p>
        </div>

        <h3 className="text-xl font-semibold mb-3 mt-6 text-gray-800">{t.tutorialPage.loadingTitle}</h3>
      ...
      <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-3xl font-semibold mb-4 text-gray-900">{t.tutorialPage.section2Title}</h2>

        <div className="space-y-6">
          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-800">{t.tutorialPage.volumeControlTitle}</h3>
            <p className="text-gray-700">{t.tutorialPage.volumeControlDesc}</p>
          </div>
          ...
          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-800">{t.tutorialPage.octaveControlTitle}</h3>
            <p className="text-gray-700">{t.tutorialPage.octaveControlDesc}</p>
          </div>

          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-800">{t.tutorialPage.reedsControlTitle}</h3>
            <p className="text-gray-700">{t.tutorialPage.reedsControlDesc}</p>
          </div>

          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-800">{t.tutorialPage.reverbControlTitle}</h3>
            <p className="text-gray-700">{t.tutorialPage.reverbControlDesc}</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-3xl font-semibold mb-4 text-gray-900">{t.tutorialPage.section3Title}</h2>

        <h3 className="text-xl font-semibold mb-3 text-gray-800">{t.tutorialPage.cMajorScaleTitle}</h3>
        <p className="text-gray-700 mb-4">{t.tutorialPage.cMajorScaleDesc}</p>

        <div className="bg-gray-50 p-4 rounded mb-4">
          <p className="font-semibold mb-2">{t.tutorialPage.cMajorScaleLabel}</p>
          <div className="space-y-2">
            <p className="text-gray-700">{t.tutorialPage.cMajorScaleKeys}</p>
            <p className="text-sm text-gray-600">{t.tutorialPage.cMajorScaleNotes}</p>
          </div>
        </div>

        <h3 className="text-xl font-semibold mb-3 mt-6 text-gray-800">{t.tutorialPage.practiceExercise1Title}</h3>
      ...
      <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-3xl font-semibold mb-4 text-gray-900">{t.tutorialPage.section4Title}</h2>

        <h3 className="text-xl font-semibold mb-3 text-gray-800">{t.tutorialPage.sargamTitle}</h3>
        <p className="text-gray-700 mb-4">{t.tutorialPage.sargamDesc}</p>
      ...
      <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-3xl font-semibold mb-4 text-gray-900">{t.tutorialPage.section6Title}</h2>

        <div className="space-y-4">
          <div className="flex items-start gap-3">
            <span className="text-2xl">🎹</span>
            <div>
              <h3 className="font-semibold text-gray-800">{t.tutorialPage.tip1Title}</h3>
              <p className="text-gray-700">{t.tutorialPage.tip1Desc}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            <span className="text-2xl">🎵</span>
            <div>
              <h3 className="font-semibold text-gray-800">{t.tutorialPage.tip2Title}</h3>
              <p className="text-gray-700">{t.tutorialPage.tip2Desc}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            <span className="text-2xl">👂</span>
            <div>
              <h3 className="font-semibold text-gray-800">{t.tutorialPage.tip3Title}</h3>
              <p className="text-gray-700">{t.tutorialPage.tip3Desc}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-800">{t.tutorialPage.tip4Title}</h3>
              <p className="text-gray-700">{t.tutorialPage.tip4Desc}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            <span className="text-2xl">🎹</span>
            <div>
              <h3 className="font-semibold text-gray-800">{t.tutorialPage.tip5Title}</h3>
              <p className="text-gray-700">{t.tutorialPage.tip5Desc}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            <span className="text-2xl">🎤</span>
            <div>
              <h3 className="font-semibold text-gray-800">{t.tutorialPage.tip6Title}</h3>
              <p className="text-gray-700">{t.tutorialPage.tip6Desc}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            <span className="text-2xl">📱</span>
            <div>
              <h3 className="font-semibold text-gray-800">{t.tutorialPage.tip7Title}</h3>
              <p className="text-gray-700">{t.tutorialPage.tip7Desc}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <h2 className="text-3xl font-semibold mb-4 text-gray-900">{t.tutorialPage.section7Title}</h2>

        <p className="text-gray-700 mb-4">{t.tutorialPage.nextStepsDesc}</p>
