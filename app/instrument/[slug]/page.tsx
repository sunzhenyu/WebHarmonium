        ...
        <nav className="flex text-sm text-gray-500 mb-8" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            <li className="inline-flex items-center">
              <Link href="/" title="Web Harmonium Home" className="hover:text-blue-600 transition-colors">
                Home
              </Link>
            </li>
            <li>
              ...
              <ul className="space-y-3 mb-8">
                {page.features.map((feature, idx) => (
                  <li key={idx} className="flex items-start">
                    <svg className="h-6 w-6 text-blue-500 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" role="img" aria-label="Checkmark icon">
            ...
            <div className="bg-blue-50 rounded-xl p-8 text-center border border-blue-100">
              ...
              <div className="flex justify-center gap-4 flex-wrap">
                <Link
                  ...
                  className="inline-flex items-center px-8 py-4 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition-colors shadow-sm hover:shadow"
                >
                ...
                <Link
                  ...
                  className="inline-flex items-center px-8 py-4 bg-white text-blue-600 font-bold rounded-lg border-2 border-blue-600 hover:bg-blue-50 transition-colors"
                >
                  View Tutorial
                </Link>
              </div>
