  ...
  return (
    <div className="bg-zinc-900 min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {/* Why section */}
        <div className="bg-zinc-800 rounded-xl border border-zinc-700 p-8 mb-6">
          <h2 className="text-2xl font-bold mb-3 text-white">{t.home.whyTitle}</h2>
          <p className="text-zinc-300 mb-6">{t.home.whyDesc}</p>

          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-4 bg-zinc-700 rounded-lg border border-zinc-600">
              <h3 className="font-semibold mb-1 text-white">{t.home.keyboardControl}</h3>
              <p className="text-sm text-zinc-300">{t.home.keyboardDesc}</p>
            </div>
            <div className="p-4 bg-zinc-700 rounded-lg border border-zinc-600">
              <h3 className="font-semibold mb-1 text-white">{t.home.transposePitch}</h3>
              <p className="text-sm text-zinc-300">{t.home.transposePitchDesc}</p>
            </div>
            <div className="p-4 bg-zinc-700 rounded-lg border border-zinc-600">
              <h3 className="font-semibold mb-1 text-white">{t.home.volumeReverb}</h3>
              <p className="text-sm text-zinc-300">{t.home.volumeReverbDesc}</p>
            </div>
            <div className="p-4 bg-zinc-700 rounded-lg border border-zinc-600">
              <h3 className="font-semibold mb-1 text-white">{t.home.multipleOctaves}</h3>
              <p className="text-sm text-zinc-300">{t.home.multipleOctavesDesc}</p>
            </div>
          </div>
        ...
        {/* Practice Exercises */}
        <div className="bg-zinc-800 rounded-xl border border-zinc-700 p-8 mb-6">
          <h2 className="text-2xl font-bold mb-2 text-white">{t.home.practiceExercises}</h2>
          <p className="text-zinc-400 mb-6">{t.home.exerciseDesc}</p>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="border border-zinc-700 rounded-lg p-4 hover:border-orange-500 transition-colors">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-400 mb-1">{ex.desc}</p>
        ...
        {/* Harmonium Notes CTA */}
        <div className="bg-zinc-800 rounded-xl border border-zinc-700 p-6 mb-6 flex flex-col sm:flex-row items-center gap-5">
          <div className="flex-1">
            <h2 className="text-xl font-bold text-white mb-1">Harmonium Notes &amp; Sargam Guide</h2>
            <p className="text-zinc-400 text-sm">Complete reference for all harmonium notes, sargam notation, keyboard mapping, and Thaat scales. Perfect for beginners learning to play.</p>
          </div>
        ...
        {/* Featured Blog Posts */}
        <div className="bg-zinc-800 rounded-xl border border-zinc-700 p-8 mb-6">
          <h2 className="text-2xl font-bold mb-2 text-white">{t.home.fromTheBlog}</h2>
          <p className="text-zinc-400 mb-5 text-sm">{t.home.blogDesc}</p>

          <div className="space-y-3">
            {featuredPosts.map(post => (
              <Link key={post.slug} href={`/blog/${post.slug}`} title={post.title[t.lang]}>
                <article className="border border-zinc-700 rounded-lg p-4 hover:border-orange-500 hover:shadow-sm transition-all">
                  <div className="flex items-center gap-2 mb-2">
                    <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${categoryColors[post.category] ?? 'bg-stone-100 text-zinc-300'}`}>
                  ...
                  <h3 className="font-bold text-white mb-1 hover:text-orange-600 transition-colors text-sm">{post.title[t.lang]}</h3>
                  <p className="text-xs text-zinc-400">{post.description[t.lang]}</p>
        ...
        <div className="pt-6 border-t border-stone-200">
          <h2 className="text-base font-semibold mb-4 text-zinc-400 text-center">{t.home.learnMoreTitle}</h2>
          <div className="flex flex-wrap justify-center gap-2">
            <Link href="/instrument/harmonium" title="Harmonium" className="px-3 py-1.5 bg-white border border-stone-200 rounded-full text-xs text-zinc-400 hover:text-orange-600 hover:border-orange-300 transition-colors shadow-sm">{t.home.harmonium}</Link>
            <Link href="/instrument/harmonium-instrument" title="Harmonium Instrument" className="px-3 py-1.5 bg-white border border-stone-200 rounded-full text-xs text-zinc-400 hover:text-orange-600 hover:border-orange-300 transition-colors shadow-sm">{t.home.harmoniumInstrument}</Link>
            <Link href="/instrument/reed-organ-harmonium" title="Reed Organ Harmonium" className="px-3 py-1.5 bg-white border border-stone-200 rounded-full text-xs text-zinc-400 hover:text-orange-600 hover:border-orange-300 transition-colors shadow-sm">{t.home.reedOrganHarmonium}</Link>
            <Link href="/instrument/harmonium-pedal-organ" title="Harmonium Pedal Organ" className="px-3 py-1.5 bg-white border border-stone-200 rounded-full text-xs text-zinc-400 hover:text-orange-600 hover:border-orange-300 transition-colors shadow-sm">{t.home.harmoniumPedalOrgan}</Link>
            <Link href="/instrument/harmonium-musical-instrument" title="Harmonium Musical Instrument" className="px-3 py-1.5 bg-white border border-stone-200 rounded-full text-xs text-zinc-400 hover:text-orange-600 hover:border-orange-300 transition-colors shadow-sm">{t.home.harmoniumMusicalInstrument}</Link>
            <Link href="/instrument/indian-harmonium" title="Indian Harmonium" className="px-3 py-1.5 bg-white border border-stone-200 rounded-full text-xs text-zinc-400 hover:text-orange-600 hover:border-orange-300 transition-colors shadow-sm">{t.home.indianHarmonium}</Link>
          </div>
        </div>
